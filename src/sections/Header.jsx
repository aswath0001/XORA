...
const NavLink = ({ title }) => (
  <LinkScroll
    className="base-bold text-p4 transition-colors duration-500 cursor-pointer
...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 z-50 w-full py-10">
      <div className="container flex h-14 items-center max-2xl:lg:px-5">
        ...
        <button
          className="lg:hidden z-2 size-10 border-2
