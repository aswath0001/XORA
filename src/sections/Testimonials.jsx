...
import { testimonials } from "../components/constants/index.jsx";
  ...
  return (
    <section className={"relative z-2 py-24 md:py-28 lg:py-40"}>
      <div className={"container block lg:flex"}>
        ...
        <div
          className={
            "testimonials_inner-after testimonials_inner-before" +
            ...
            {testimonials.slice(halfLength).map((testimonial) => (
              <TestimonialItem
                ...
                containerClassName="last:after:hidden
                         after:right-auto after:left-0 after:max-md:-left-4 md:px12
                         "
              />
            ))}
          </div>
